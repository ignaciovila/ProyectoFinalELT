...
<link href="<c:url value="/css/comentario.css" />" rel="stylesheet">
	...
	<script>
	 	$(function() {
	 	    $("#buscador").autocomplete({
		 	    source: "/trackandbug/api/proyectos/autocomplete.json",
		 	    minLength: 2,
		 	    select: function( event, ui ) {
		 	    	window.location = '/trackandbug/proyectos/verproyecto/verproyecto.html?id=' + ui.item.id;
				}
			});
	 	});
	</script>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<c:url value="/proyectos/listado/listar.html" />">Proyectos</a></li>
          	<li><a href="<c:url value="/usuarios/listar.html" />">Usuarios</a></li>
<!--           	buscador -->
          	<li>
		      <form class="navbar-form navbar-left">
		        <div class="form-group">
		          <input id="buscador" type="text" class="form-control" placeholder="Buscar proyecto">
		        </div>
		      </form>
            </li>
<!--             fin buscador -->
